...
# consider different arrival patterns
# 1. different poisson distribution
# 2. periodic Pattern
...
for i_episode in range(NUM_EPISODE):
    ...
    for len in range(LEN_EPISODE):  #length of each episode
        ...
        result[len][i_episode] = round(ep_r, 3)     # current total reward
...
with open('A2C-on-policy-singlestep.txt', 'a+') as f:
    for x in res:
        f.write(str(x.item())+'\n')
